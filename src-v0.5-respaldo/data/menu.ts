...
export const menu: MenuProduct[] = [
  ...
  simple(
    ...
    "frutas-saladas",
    "¡Ármala a tu gusto!",
    "Escoge exactamente 7 ingredientes.",
    90,
    {
      featured: true,
      groups: [
  ...
  simple("combo-individual", "snacks-calientes", "Combo Individual", "3 alitas, 5 boneless, papas y aros.", 140),
  simple("combo-familiar", "snacks-calientes", "Combo Familiar", "Alitas, boneless y papas.", 225),
  simple("combo-parejas", "snacks-calientes", "Combo Parejas", "Alitas, boneless, hotcakes, fruta con crema y charola salada.", 285),
  simple("combo-kids", "snacks-calientes", "Combo Kids", "Nuggets o palomitas, papas y brocheta.", 165),
  simple("combo-amigos", "snacks-calientes", "Combo Amigos", "Alitas, nachos, papas gajo y papas locas.", 235),
  ...
  ...drinks.map(([id, name, price]) =>
    simple(id, "bebidas", name, "Drink preparado al momento.", price, {
